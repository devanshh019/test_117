...
_target_plot_path = r'/Users/devanshkumarverma/Desktop/PS117-v2.0.0/backend/data/storage/plot_exec_sim_1788158293364.png'
...
# Alternatively, use the mathematical formula for the sum of an arithmetic series
# Sum = n * (n + 1) / 2, where n is the number of terms (100 in this case)
n = 100
sum_formula = n * (n + 1) // 2  # Use // for integer division
print(f"The sum of numbers from 1 to 100 (using formula) is: {sum_formula}")
