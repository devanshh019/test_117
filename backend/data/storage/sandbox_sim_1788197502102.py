...
_target_plot_path = r'/Users/devanshkumarverma/Desktop/PS117-v2.0.0/backend/data/storage/plot_sandbox_sim_1788197502102.png'
...
import matplotlib.pyplot as plt
t_min = 0.25
plt.plot([t_min, t_min], [0, 1], label='Minimum Thickness', color='red')
