...
_target_plot_path = r'/Users/devanshkumarverma/Desktop/PS117-v2.0.0/backend/data/storage/plot_sandbox_sim_1788197476975.png'
...
plt.title('ASME Thickness Calculation')
plt.show()
