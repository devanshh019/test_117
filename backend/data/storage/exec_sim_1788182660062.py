...
_target_plot_path = r'/Users/devanshkumarverma/Desktop/PS117-v2.0.0/backend/data/storage/plot_exec_sim_1788182660062.png'
...
# Load the image
img = mpimg.imread('arushi.jpg')

# Display the image
plt.imshow(img)
plt.axis('off')  # Turn off axis labels and ticks
plt.title('Image of Arushi')
plt.grid(False)
plt.show()
