...
_target_plot_path = r'/Users/devanshkumarverma/Desktop/PS117-v2.0.0/backend/data/storage/plot_exec_sim_1788199405356.png'
...
print(approval_note.format(np.min(ultrasonic_thickness), np.max(ultrasonic_thickness), allowable_stress))
